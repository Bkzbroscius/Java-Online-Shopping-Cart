...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <body>
      ...
      <c:set var="n"><%= java.lang.Math.round(java.lang.Math.random() * 1000) %></c:set>
        <div class="big prods image left"><img src="Images/spinach.jpg" class="plant">Delicious spinach. Fresh from our garden.<br>
         <div class="price">$3.00</div><div class="addItem">
       
      </div>
      <div>
			<form action="CartController" method="get">
				Quantity<input type="number" name="quantity" min=1> <input
					type="hidden" name="action" value="addtoCart"> <input
					type="hidden" name="productId" value="7"> <input
					type="hidden" name="description" value="Spinach"> <input
					type="hidden" name="price" value="3.00"> <input
					type="hidden" name="action" value="addtoCart"> <input
					type="hidden" name="orderId" value=<c:out value="${n}"/>> <input
