...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <body>
      ...
      <c:set var="n"><%= java.lang.Math.round(java.lang.Math.random() * 1000) %></c:set>
        <div class="big prods image left"><img src="Images/potatoes.jpg" class="plant">Delicious potatoes. Fresh from our garden.<br>
         <div class="price">$1.00</div><div class="addItem">
